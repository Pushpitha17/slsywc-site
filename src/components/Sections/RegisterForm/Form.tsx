  ...
  return (
    <Form {...form}>
      ...
      >
        ...
        {exco === "Yes" && (
          <>
            <div className="font-bold text-lg">Executive Committee Details</div>
        ...
        {exco === "No" && (
          <>
            ...
            >
              <div>
                Select the entity/entities you are currently an volunteering in
              </div>
            </CheckBoxesInput>
            <CustomTextInput
              form={form}
        ...
        >
          <div>
            Acceptance of IEEE policies is required to register for this event.
            By submitting your registration details, you acknowledge that you
