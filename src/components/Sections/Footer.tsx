      ...
      <div className="container py-6">
        <div className="md:flex justify-between">
          <div className="max-w-[50ch]">
            <p className="font-bold text-2xl md:text-5xl pb-4 bg-text-gradient text-transparent bg-clip-text">
              SLSYWC&apos;25
            </p>
            <p>
          ...
          <div className="py-6 md:py-0 min-w-[30ch]">
            ...
            <ul>
              <li className="underline mb-1">
                <a href="https://ieee.lk/" target="_blank">
                  IEEE Sri Lanka Section
                </a>
              </li>
              <li className="underline mb-1">
                <a
                  href="https://ieee.lk/community/student-activities-committee/"
                  target="_blank"
                >
                  SLSAC
                </a>
              ...
              <li className="underline mb-1">
                <a
                  href="https://ieee.lk/community/young-professionals/"
                  target="_blank"
                >
                  Young Professionals
                </a>
              ...
              <li className="underline mb-1">
                <a href="https://ieeewie.lk/" target="_blank">
                  WIE
                </a>
              </li>
            </ul>
